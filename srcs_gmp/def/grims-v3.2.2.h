...
#define STOCH         /* stochastic tendency perturbation in dyn and phy */
...
#undef GRIMSCV_STRONG /* strong diffusion in kz and active trigger */
...
#undef   FLOW_BLOCKING /* kim-doyle orographic flow-blocking drag */
