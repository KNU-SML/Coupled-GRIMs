...
#define OSULSM2       /* osu lsm with heterogeneous vegatation and soil type */
...
#define  USGS_SFC     /* usgs surface and vegetation data */
#ifdef RMP
#undef  USGS_SFC
#endif
#undef VIC
...
#define MRFPBL       /* ysu pbl scheme or mrf scheme */
...
#define  RAS          /* relaxed arakawa-schubert ras cps */
