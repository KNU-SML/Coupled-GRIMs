#include <define.h>
   subroutine chgrp_extrap_moisture(stdprs,qin,t,qou,ijdim,kdimi,kdimqi,xlat)
!-------------------------------------------------------------------------------
!
! subprogram: chgrp_extrap_moisture
!
! abstract :
...
!
   real qq1(8,19),qq(8,19)
   data qq1 /32*5.  ,  4.8,4.55,4.5,4.6,4.7,4.75,4.75,4.7,                     &
