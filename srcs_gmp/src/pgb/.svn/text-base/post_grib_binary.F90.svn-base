#include <define.h>
   subroutine post_grib_binary(ibm,ids,len,mg,g,ground,gmin,gmax,nbit)    
!-------------------------------------------------------------------------------
!                                                                               
! subprogram:    post_grib_binary      compute number of bits and round field.
!                                                                               
...
!                                                                               
! usage:    call post_grib_binary(ibm,ids,len,mg,g,gmin,gmax,nbit)    
!   input argument list:                                                        
...
!                                                                               
! subprograms called:                                                           
!   isrchnex  - find first value in an array not equal to target value           
!                                                                               
!-------------------------------------------------------------------------------
