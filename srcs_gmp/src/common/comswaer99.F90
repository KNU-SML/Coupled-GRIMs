!
   module comswaer99
!-------------------------------------------------------------------------------
   use rdparm99, only : rdparm99_init, l,nbd,lp1
!-------------------------------------------------------------------------------
   implicit none
!-------------------------------------------------------------------------------
   integer, parameter ::  nae=7,ndm=5,ncm1=6,ncm2=4,ncm=ncm1+ncm2,ncf=3
   integer, private   ::  i, j, k
   real               ::  tauray(12)
   real               ::  haer(ndm,nae)
   real               ::  sigref(ndm,nae)
   real               ::  ext0(ncm1,nbd),sca0(ncm1,nbd),ssa0(ncm1,nbd),estr(nbd)
...
!-------------------------------------------------------------------------------
   ...
   allocate(hz(lp1))
!
   end subroutine comswaer99_init
!-------------------------------------------------------------------------------
   end module comswaer99
