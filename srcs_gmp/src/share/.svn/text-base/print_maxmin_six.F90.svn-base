#include <define.h>
   subroutine print_maxmin_six(a,len,k,k1,k2,ch) 
!-------------------------------------------------------------------------------
!
...
!
! usage:    call  print_maxmin_six(a,len,k,k1,k2,ch)
!   input argument list:
...
!     ch    - charcter string to print fpl and fml
!
...
!
   return                                                                    
   end subroutine print_maxmin_six
!-------------------------------------------------------------------------------
