...
#ifdef DCMIP
SUBROUTINE test5_tropical_cyclone (lon,lat,p,z,zcoords,hybrid_eta,hyam,hybm,u,v,w,t,phis,ps,rho,q)
#else
...
!-----------------------------------------------------------------------
#ifdef DCMIP
    logical, intent(in)  :: hybrid_eta 
    real(8), intent(in)  :: hyam,hybm
#endif
