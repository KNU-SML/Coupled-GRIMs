#include <define.h>
   subroutine mpnk2nx(a,lonf2,lota,                                            &
                      b,lonf2p,lotb,latg2p,levsp,levs,leva,levb,nvar)
!-------------------------------------------------------------------------------
!
...
!
!-------------------------------------------------------------------------------
!  use commpi, only : mype, ncol, comm_row, latlen, latstr, levstr, levlen,    &
   use commpi       ! mype, ncol, comm_row, latlen, latstr, levstr, levlen,    &
                    ! MPI_REAL, latdef
#ifdef REDUCE_GRID
