...
!   call mpi_comm_rank(mpi_comm_world,mype,jerr)
   call mpi_comm_size(mpi_comm_private,npes,ierr)
   call mpi_comm_rank(mpi_comm_private,mype,jerr)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!     call mpi_comm_split(mpi_comm_world,mycol,myrow,comm_column,jerr)
     call mpi_comm_split(mpi_comm_private,myrow,mycol,comm_row,ierr)
     call mpi_comm_split(mpi_comm_private,mycol,myrow,comm_column,jerr)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
