...
!   use commpi, only : mpi_comm_world, MPI_REAL, mype, master
   use commpi, only : mpi_comm_private, MPI_REAL, mype, master
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!-------------------------------------------------------------------------------
   implicit none
!-------------------------------------------------------------------------------
...
!   call mpi_bcast(tmpa,len,MPI_REAL,0,mpi_comm_world,ierr)
   call mpi_bcast(tmpa,len,MPI_REAL,0,mpi_comm_private,ierr)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!
   do i=1,len
      a(i) = tmpa(i)
