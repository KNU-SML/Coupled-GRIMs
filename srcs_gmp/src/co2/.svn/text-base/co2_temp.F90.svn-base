!
   function co2_temp(l,z)                                                      
!-------------------------------------------------------------------------------
   dimension zb(10,7),c(11,7),delta(10,7),tstar(7)                           
!
! ************** tropical sounding **************************                   
   data (zb(n,1),n=1,10)/                                                      & 
        2.0,   3.0,   16.5,  21.5,  45.0,                                      &
...
!                                                                               
   data tstar/                                                                 & 
        300.0,  294.0,  272.2,  287.0,  257.1, 2*288.15/                       
!                                                                               
   nlast=10                                                                  
