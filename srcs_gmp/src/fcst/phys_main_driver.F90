...
!     intsec_send=intsec+300.
     intsec_send=intsec+1200.
     print*, "intsec =", intsec
...
!cpl_send(input,intsec,var_id)
     ...
     elseif ( mod(intsec_send, 3600) .eq. 0 ) then
!     elseif ( mod(intsec_send, 21600) .eq. 0 ) then
