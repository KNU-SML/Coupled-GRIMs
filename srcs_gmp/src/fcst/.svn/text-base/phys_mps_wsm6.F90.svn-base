...
!-------------------------------------------------------------------------------
   ...
   SUBROUTINE wsm62D(t, q                                                      &
                    ...
                    ,delt,g, cpd, cpv, rd, rv, t0c                             &
#else
   SUBROUTINE phys_mps_wsm6(t1, q1                                             &
                    ,q2, ncloud, p, delz                                       &
...
!
     do n = 1,mstepmax
       ...
       do k = kts,kte
         ...
         enddo
       enddo
       call slope_wsm6(qrs_tmp,den_tmp,denfac,t,rslope,rslopeb,rslope2,        &
...
#else
         rainncv(i) = fallsum*delz(i,kts)/denr*dtcld
