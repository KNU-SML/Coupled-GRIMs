#include <define.h>
   subroutine osu1tovic1(sfcfcsin,idim,jdim,numsfcsin)
!------------------------------------------------------------------------------
!
! fill vic1 type surface file records from osu1 type
!
!------------------------------------------------------------------------------
   use varsfc, only : lsoil_,nsoil_,lalbd_
   use comsfc
!------------------------------------------------------------------------------
   implicit none
!------------------------------------------------------------------------------
...
!       vroot, binf, Ds, Dsm, Ws,cef, expt, kest, dph, bub, qrt, 
...
!
   ...
   enddo
!
! mod by hoon from "do l = 1,lalbd_"
!
   do l = 2,lalbd_
     do j = 1,jdim
       do i = 1,idim
