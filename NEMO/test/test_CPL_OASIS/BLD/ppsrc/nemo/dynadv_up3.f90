...
CONTAINS
   ...
   SUBROUTINE dyn_adv_up3( kt, Kbb, Kmm, puu, pvv, Krhs )
      ...
      REAL(dp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) :: zfu_t
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) :: zfv_f, zfv
      REAL(dp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) :: zfv_t
      REAL(dp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) :: ztrdu, ztrdv
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) :: zlu_uu, zlu_uv
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) :: zlv_vv, zlv_vu
      REAL(dp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)) :: zfw, zfu_uw, zfv_vw, zlu_uw, zlv_vw
      !!----------------------------------------------------------------------
      !
      ...
      DO jk = 1, jpkm1                       !  Laplacian of the velocity  !
         ...
         END DO   ;   END DO
         !            
         DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)                       ! laplacian
      ...
      ENDIF
      !
      DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)                        ! uniform shear in the 1st layer : dz(u(k=1)) = dz(u(k=2)) ==> zlu = 0
         zlu_uw(ji,jj) = 0._wp
         zlv_vw(ji,jj) = 0._wp
      END DO   ;   END DO
      !
      DO jk = 1, jpk-2                    != divergence of advective fluxes =! (jk = 1 to jpk-2)
         DO jj = ntsj-( 0), ntej+( 1 ) ; DO ji = ntsi-( 0), ntei+( 1)                  ! vertical transport at level k+1
