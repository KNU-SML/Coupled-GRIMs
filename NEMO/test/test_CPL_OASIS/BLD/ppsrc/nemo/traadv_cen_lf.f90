...
CONTAINS
   ...
   SUBROUTINE tra_adv_cen_lf( kt, kit000, cdtype, pU, pV, pW,     &
      ...
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) ::   zwx, zwy, zwz, ztw
      !!----------------------------------------------------------------------
      !
      ...
      DO jn = 1, kjpt            !==  loop over the tracers  ==!
         ...
         CASE(  4  )                         !* 4th order centered
            DO jk =  1,  jpkm1  ; DO jj = ntsj-(  1), ntej+(  0) ; DO ji = ntsi-( 1), ntei+(  0)           ! Horizontal advective fluxes
