...
CONTAINS
   ...
   SUBROUTINE zdf_ddm( kt, Kmm, p_avm, p_avt, p_avs )
      ...
      REAL(dp) ::          zavfs    !   -      -
      REAL(wp) ::   zavdt, zavds    !   -      -
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)) ::   zrau, zmsks, zmskf, zmskd1, zmskd2, zmskd3
      !!----------------------------------------------------------------------
      !
      !                                                ! ===============
...
!!gm                            and many acces in memory
         ...
         DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)           !==  R=zrau = (alpha / beta) (dk[t] / dk[s])  ==!
...
!!gm please, use e3w at Kmm below 
         ...
         DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)           !==  indicators  ==!
