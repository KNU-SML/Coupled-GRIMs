...
CONTAINS
   ...
   SUBROUTINE tra_adv_mus( kt, kit000, cdtype, p2dt, pU, pV, pW,             &
      ...
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) ::   zwx, zslpx   ! 3D workspace
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) ::   zwy, zslpy   ! -      -
      !!----------------------------------------------------------------------
      !
      ...
      DO jn = 1, kjpt            !==  loop over the tracers  ==!
         ...
         END DO   ;   END DO   ;   END DO
         !
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)    !-- Slopes limitation
         ...
         !
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  1), ntej+(  0) ; DO ji = ntsi-( 1), ntei+(  0)    !-- MUSCL horizontal advective fluxes
            ! MUSCL fluxes
         ...
         END DO   ;   END DO   ;   END DO
         !
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)    !-- Tracer advective trend
         ...
         zwx(:,:,jpk) = 0._wp
         DO jk =  2,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)                ! interior values
         ...
         END DO   ;   END DO   ;   END DO
         DO jk =  2,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)    !-- Slopes limitation
            zslpx(ji,jj,jk) = SIGN( 1.0_wp, zslpx(ji,jj,jk) ) * MIN(    ABS( zslpx(ji,jj,jk  ) ),   &
               &                                                     2.*ABS( zwx  (ji,jj,jk+1) ),   &
               &                                                     2.*ABS( zwx  (ji,jj,jk  ) )  )
         END DO   ;   END DO   ;   END DO
         DO jk =  1,  jpk-2  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)    !-- vertical advective flux
         ...
         ENDIF
         !
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)     !-- vertical advective trend
