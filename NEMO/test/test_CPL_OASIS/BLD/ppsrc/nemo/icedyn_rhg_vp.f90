...
!!!      REAL(wp), DIMENSION(jpi,jpj) ::   ztaux_base, ztauy_base          ! ice-bottom stress at U-V points (landfast)
     !
      ...
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)
      ...
      DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls) ! 2->jpj-1; 2->jpi-1
      ...
      DO i_out = 1, nn_vp_nout
         ...
         DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1) ! 1->jpi-1
         ...
         DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)! 1-> jpj-1; 1->jpi-1
         ...
         DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls)
         ...
         DO jj = ntsj-( nn_hls-1), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls) ! 2 -> jpj; 2,jpi !!! CHECK !!!
         ...
         DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls) ! 2 -> jpj; 2,jpi !!! CHECK !!!
         ...
         DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1) ! 2->jpj-1; 2->jpi-1
         ...
         DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1) ! 2->jpj-1; 2->jpi-1
...
!!$                                         &         * vmask(ji,jpj-1,1)  ! last row
      ...
      DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0) ! 2->jpj-1; 2->jpi-1
     ...
     &     iom_use('sig1_pnorm') .OR. iom_use('sig2_pnorm') ) THEN
         ...
         DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls) ! 2->jpj-1; 2->jpi-1
...
!!$         CALL lbc_lnk( 'icedyn_rhg_vp', zs1, 'T', 1._wp, zs2, 'T', 1._wp, zs12, 'T', 1._wp )
      ...
      IF(  iom_use('utau_oi') .OR. iom_use('vtau_oi') .OR. iom_use('utau_ai') .OR. iom_use('vtau_ai') .OR. &
         ...
         DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1) ! 2->jpj-1; 2->jpi-1
...
!!$         CALL lbc_lnk( 'icedyn_rhg_vp', zsig_I, 'T', 1._wp, zsig_II, 'T', 1._wp)
      ...
      IF( iom_use('sig1_pnorm') .OR. iom_use('sig2_pnorm') ) THEN
         ...
         !         
         DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0) ! clem: check bounds
