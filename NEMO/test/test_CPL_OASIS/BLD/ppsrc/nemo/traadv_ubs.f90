   ...
   SUBROUTINE tra_adv_ubs( kt, kit000, cdtype, p2dt, pU, pV, pW,          &
      ...
      DO jn = 1, kjpt                                            ! tracer loop
         ...
         DO jk = 1, jpkm1                !==  horizontal laplacian of before tracer ==!
            DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)                   ! First derivative (masked gradient)
            ...
            END DO   ;   END DO
            DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)                   ! Second derivative (divergence)
         ...
         !
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  1), ntej+(  0) ; DO ji = ntsi-( 1), ntei+(  0)   !==  Horizontal advective fluxes  ==!     (UBS)
