...
CONTAINS
   ...
   SUBROUTINE tra_adv( kt, Kbb, Kmm, pts, Krhs )
      ...
      ! TEMP: [tiling] This change not necessary and can be ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls) after all lbc_lnks removed in the nn_hls = 2 case in tra_adv_fct
...
!!gm ???
         ...
         CALL dia_ptr( kt, Kmm, zvv(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),:) )                                    ! diagnose the effective MSF
!!gm ???
         !
