...
CONTAINS
   ...
   SUBROUTINE sbc_stokes( Kmm )
      ...
      !
         ...
         DO jj = ntsj-( 1), ntej+( 1 ) ; DO ji = ntsi-( 1), ntei+( 1) ! In the deep-water limit we have ke = ||ust0||/( 6 * ||transport|| )
      ...
      !# define zInt_w ze3divh
         DO jk =  1,  jpk  ; DO jj = ntsj-(  1), ntej+(  1) ; DO ji = ntsi-( 1), ntei+(  1) ! Compute the primitive of Breivik 2016 function at W-points
...
!
         DO jk = 1, jpkm1
            zfac = 0.166666666667_wp
            DO jj = ntsj-( 1), ntej+( 1 ) ; DO ji = ntsi-( 1), ntei+( 1) !++ Compute the FV Breivik 2016 function at T-points
            ...
            END DO   ;   END DO
            DO jj = ntsj-( 1), ntej+( 0 ) ; DO ji = ntsi-( 1), ntei+( 0) ! ++ Interpolate at U/V points
      ...
      ELSE
         ...
         END DO   ;   END DO
         DO jj = ntsj-( 1), ntej+( 0 ) ; DO ji = ntsi-( 1), ntei+( 0)          ! exp. wave number & Stokes drift velocity at u- & v-points
      ...
      !
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  1) ; DO ji = ntsi-( 0), ntei+(  1)    ! Horizontal e3*divergence
