...
CONTAINS
   ...
   INTEGER FUNCTION zdf_osm_alloc()
      ...
      !
      ALLOCATE( etmean(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk), dh(jpi,jpj), r1_ft(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), STAT=ierr )
      zdf_osm_alloc = zdf_osm_alloc + ierr
      !
      ALLOCATE( nbld(jpi,jpj), nmld(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), STAT=ierr )
      zdf_osm_alloc = zdf_osm_alloc + ierr
      !
      ALLOCATE( n_ddh(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), STAT=ierr )
      zdf_osm_alloc = zdf_osm_alloc + ierr
      !
      ALLOCATE( l_conv(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), l_shear(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), l_coup(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), l_pyc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),   &
         &      l_flux(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), l_mle(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),   STAT=ierr )
      zdf_osm_alloc = zdf_osm_alloc + ierr
      !
      ALLOCATE( swth0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),  sws0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      swb0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      suw0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      &
         &      sustar(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), scos_wind(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), ssin_wind(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), swthav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),    &
         &      swsav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),  swbav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),     sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),    dstokes(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),   &
         &      swstrl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),    sla(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),       svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),     &
         &      shol(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),   STAT=ierr )
      zdf_osm_alloc = zdf_osm_alloc + ierr
      !
   ...
   SUBROUTINE zdf_osm( kt, Kbb, Kmm, Krhs, p_avm,   &
      ...
      !! Scales
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zrad0       ! Surface solar temperature flux (deg m/s)
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zradh       ! Radiative flux at bl base (Buoyancy units)
      REAL(wp)                           ::   zradav      ! Radiative flux, bl average (Buoyancy Units)
      REAL(wp)                           ::   zvw0        ! Surface v-momentum flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zwb0tot     ! Total surface buoyancy flux including insolation
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zwb_ent     ! Buoyancy entrainment flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zwb_min
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zwb_fk_b    ! MLE buoyancy flux averaged over OSBL
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zwb_fk      ! Max MLE buoyancy flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdiff_mle   ! Extra MLE vertical diff
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zvel_mle    ! Velocity scale for dhdt with stable ML and FK
      !! Mixed-layer variables
      INTEGER,  DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   jk_nlev  ! Number of levels
      INTEGER,  DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   jk_ext   ! Offset for external level
      !!
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zhbl   ! BL depth - grid
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zhml   ! ML depth - grid
      !!
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zhmle   ! MLE depth - grid
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls))   ::   zmld    ! ML depth on grid
      !!
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdh                          ! Pycnocline depth - grid
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdhdt                        ! BL depth tendency
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdtdz_bl_ext, zdsdz_bl_ext   ! External temperature/salinity gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdbdz_bl_ext                 ! External buoyancy gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls))   ::   zdtdx, zdtdy, zdsdx, zdsdy   ! Horizontal gradients for Fox-Kemper parametrization
      !!
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdbds_mle   ! Magnitude of horizontal buoyancy gradient
      !! Flux-gradient relationship variables
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zshear   ! Shear production
      !!
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zhbl_t   ! Holds boundary layer depth updated by full timestep
      !! For calculating Ri#-dependent mixing
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)) ::   z2du     ! u-shear^2
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)) ::   z2dv     ! v-shear^2
      ...
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk)   ::   zviscos          ! Viscosity
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk)   ::   zdiffut          ! t-diffusivity
      REAL(wp)                                 ::   zabsstke
      ...
      !!----------------------------------------------------------------------
      !
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         nmld(ji,jj)   = 0
      ...
      DO jk =  1,  jpk  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
      ...
      DO jj = ntsj-(  nn_hls-( nn_hls+ nn_hls )*nthb), ntej+(  nn_hls -( nn_hls + nn_hls)*ntht) ; DO ji = ntsi-( nn_hls-( nn_hls+ nn_hls)*nthl), ntei+(  nn_hls-( nn_hls+ nn_hls)*nthr)
         nbld(ji,jj) = 4
      END DO   ;   END DO
      DO jk =  5,  jpkm1  ; DO jj = ntsj-(   nn_hls-(  nn_hls+  nn_hls)*nthb), ntej+(   nn_hls-(  nn_hls+  nn_hls)*ntht) ; DO ji = ntsi-( nn_hls-( nn_hls+  nn_hls)*nthl), ntei+(   nn_hls-(  nn_hls+ nn_hls)*nthr)
      ...
      jk_nlev(:,:) = nbld(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
      jk_ext(:,:) = 1   ! ag 19/03
      ...
      jk_nlev(:,:) = nmld(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) - 1
      jk_ext(:,:) = nbld(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) - nmld(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) + jk_ext(:,:) + 1   ! ag 19/03
      ...
      IF ( ln_osm_mle ) THEN
         ...
         DO jj = ntsj-(  nn_hls-( nn_hls+ nn_hls )*nthb), ntej+(  nn_hls -( nn_hls + nn_hls)*ntht) ; DO ji = ntsi-( nn_hls-( nn_hls+ nn_hls)*nthl), ntei+(  nn_hls-( nn_hls+ nn_hls)*nthr)
            mld_prof(ji,jj) = 4
         END DO   ;   END DO
         DO jk =  5,  jpkm1  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
            IF ( hmle(ji,jj) >= gdepw(ji,jj,jk,Kmm) ) mld_prof(ji,jj) = MIN( mbkt(ji,jj), jk)
         END DO   ;   END DO   ;   END DO
         jk_nlev(:,:) = mld_prof(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
      ...
      jk_ext(:,:) = nbld(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) + 1
      ...
      !      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)                                         Removed with ag 19/03 changes. A change in eddy diffusivity/viscosity
      ...
      END DO   ;   END DO
      !
      DO jk =  4,  jpkm1  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
      ...
      END DO   ;   END DO
      !
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)               ! Limit delta for shallow boundary layers for calculating
      ...
      IF ( ln_dia_osm ) THEN
         ...
         CASE(0:1)
            CALL zdf_osm_iomput( "us_x", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sustke(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * scos_wind(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )   ! x surface Stokes drift
            CALL zdf_osm_iomput( "us_y", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sustke(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * ssin_wind(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )   ! y surface Stokes drift
            CALL zdf_osm_iomput( "wind_wave_abs_power", 1000.0_wp * rho0 * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sustar(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))**2 * sustke(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )
            ! Stokes drift read in from sbcwave  (=2).
         CASE(2:3)
            CALL zdf_osm_iomput( "us_x",   ut0sd(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * umask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) )                         ! x surface Stokes drift
            CALL zdf_osm_iomput( "us_y",   vt0sd(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * vmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) )                         ! y surface Stokes drift
            CALL zdf_osm_iomput( "wmp",    wmp(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) )                           ! Wave mean period
            CALL zdf_osm_iomput( "hsw",    hsw(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) )                           ! Significant wave height
            CALL zdf_osm_iomput( "wmp_NP", ( 2.0_wp * rpi * 1.026_wp / ( 0.877_wp * grav ) ) *   &   ! Wave mean period from NP
               &                           wndm(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) )                          !    spectrum
            CALL zdf_osm_iomput( "hsw_NP", ( 0.22_wp / grav ) * wndm(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))**2 * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) )  ! Significant wave height from
            !                                                                                        !    NP spectrum
            CALL zdf_osm_iomput( "wndm",   wndm(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) )                          ! U_10
            CALL zdf_osm_iomput( "wind_wave_abs_power", 1000.0_wp * rho0 * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sustar(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))**2 *   &
               &                                        SQRT( ut0sd(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))**2 + vt0sd(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))**2 ) )
         END SELECT
         CALL zdf_osm_iomput( "zwth0",           tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * swth0(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! <Tw_0>
         CALL zdf_osm_iomput( "zws0",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sws0(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! <Sw_0>
         CALL zdf_osm_iomput( "zwb0",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * swb0(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! <bw_0>
         CALL zdf_osm_iomput( "zwbav",           tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * swbav(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! Upward BL-avged turb buoyancy flux
         CALL zdf_osm_iomput( "ibld",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * nbld(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! Boundary-layer max k
         CALL zdf_osm_iomput( "zdt_bl",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_dt_bl(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! dt at ml base
         CALL zdf_osm_iomput( "zds_bl",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_ds_bl(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! ds at ml base
         CALL zdf_osm_iomput( "zdb_bl",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_db_bl(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! db at ml base
         CALL zdf_osm_iomput( "zdu_bl",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_du_bl(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! du at ml base
         CALL zdf_osm_iomput( "zdv_bl",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_dv_bl(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! dv at ml base
         CALL zdf_osm_iomput( "dh",              tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * dh(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))        )      ! Initial boundary-layer depth
         CALL zdf_osm_iomput( "hml",             tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * hml(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))       )      ! Initial boundary-layer depth
         CALL zdf_osm_iomput( "zdt_ml",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_dt_ml(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! dt at ml base
         CALL zdf_osm_iomput( "zds_ml",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_ds_ml(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! ds at ml base
         CALL zdf_osm_iomput( "zdb_ml",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_db_ml(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! db at ml base
         CALL zdf_osm_iomput( "dstokes",         tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * dstokes(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))   )      ! Stokes drift penetration depth
         CALL zdf_osm_iomput( "zustke",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sustke(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))    )      ! Stokes drift magnitude at T-points
         CALL zdf_osm_iomput( "zwstrc",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * swstrc(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))    )      ! Convective velocity scale
         CALL zdf_osm_iomput( "zwstrl",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * swstrl(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))    )      ! Langmuir velocity scale
         CALL zdf_osm_iomput( "zustar",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sustar(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))    )      ! Friction velocity scale
         CALL zdf_osm_iomput( "zvstr",           tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * svstr(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! Mixed velocity scale
         CALL zdf_osm_iomput( "zla",             tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * sla(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))       )      ! Langmuir #
         CALL zdf_osm_iomput( "wind_power",      1000.0_wp * rho0 * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) *   &   ! BL depth internal to zdf_osm routine
            &                                    sustar(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))**3 )
         CALL zdf_osm_iomput( "wind_wave_power", 1000.0_wp * rho0 * tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) *   &
            &                                    sustar(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))**2 * sustke(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )
         CALL zdf_osm_iomput( "zhbl",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zhbl(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! BL depth internal to zdf_osm routine
         CALL zdf_osm_iomput( "zhml",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zhml(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! ML depth internal to zdf_osm routine
         CALL zdf_osm_iomput( "imld",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * nmld(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! Index for ML depth internal to zdf_osm
         !                                                                                  !    routine
         CALL zdf_osm_iomput( "jp_ext",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * jk_ext(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))    )      ! =1 if pycnocline resolved internal to
         !                                                                                  !    zdf_osm routine
         CALL zdf_osm_iomput( "j_ddh",           tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * n_ddh(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! Index forpyc thicknessh internal to
         !                                                                                  !    zdf_osm routine
         CALL zdf_osm_iomput( "zshear",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zshear(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))    )      ! Shear production of TKE internal to
         !                                                                                  !    zdf_osm routine
         CALL zdf_osm_iomput( "zdh",             tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zdh(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))       )      ! Pyc thicknessh internal to zdf_osm
         !                                                                                  !    routine
         CALL zdf_osm_iomput( "zhol",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * shol(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! ML depth internal to zdf_osm routine
         CALL zdf_osm_iomput( "zwb_ent",         tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zwb_ent(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))   )      ! Upward turb buoyancy entrainment flux
         CALL zdf_osm_iomput( "zt_ml",           tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * av_t_ml(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))   )      ! Average T in ML
         CALL zdf_osm_iomput( "zmld",            tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zmld(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))      )      ! FK target layer depth
         CALL zdf_osm_iomput( "zwb_fk",          tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zwb_fk(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))    )      ! FK b flux
         CALL zdf_osm_iomput( "zwb_fk_b",        tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zwb_fk_b(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! FK b flux averaged over ML
         CALL zdf_osm_iomput( "mld_prof",        tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * mld_prof(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! FK layer max k
         CALL zdf_osm_iomput( "zdtdx",           umask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zdtdx(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! FK dtdx at u-pt
         CALL zdf_osm_iomput( "zdtdy",           vmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zdtdy(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! FK dtdy at v-pt
         CALL zdf_osm_iomput( "zdsdx",           umask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zdsdx(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! FK dtdx at u-pt
         CALL zdf_osm_iomput( "zdsdy",           vmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zdsdy(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))     )      ! FK dsdy at v-pt
         CALL zdf_osm_iomput( "dbdx_mle",        umask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * dbdx_mle(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! FK dbdx at u-pt
         CALL zdf_osm_iomput( "dbdy_mle",        vmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * dbdy_mle(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )      ! FK dbdy at v-pt
         CALL zdf_osm_iomput( "zdiff_mle",       tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zdiff_mle(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )      ! FK diff in MLE at t-pt
         CALL zdf_osm_iomput( "zvel_mle",        tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zvel_mle(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )       ! FK velocity in MLE at t-pt
      END IF
      !
   ...
   SUBROUTINE zdf_osm_vertical_average( Kbb, Kmm, knlev, pt, ps,   &
      ...
      INTEGER,  DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   )           ::   knlev      ! Number of levels to average over.
      ...
      INTEGER,  DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ), OPTIONAL ::   kp_ext     ! External-level offsets
      ...
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zthick                     ! Layer thickness
      ...
      END DO   ;   END DO
      DO jk =  2,  jkflt  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)   ! Upper, flat part of layer
      ...
      END DO   ;   END DO   ;   END DO
      DO jk =  jkflt+1,  jkmax  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)   ! Lower, non-flat part of layer
   ...
   SUBROUTINE zdf_osm_velocity_rotation_3d( pu, pv, fwd, ktop, knlev )
      ...
      INTEGER,  OPTIONAL, INTENT(in   ), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   knlev    ! Array of maximum depth indices
      !!
      ...
      ELSE
         ...
         llkbot = .TRUE.
      END IF
      DO jk =  jktop,  jkmax  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
   ...
   SUBROUTINE zdf_osm_osbl_state( Kmm, pwb_ent, pwb_min, pshear, phbl,   &
      ...
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(  out) ::   pwb_ent   ! Buoyancy fluxes at base
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(  out) ::   pwb_min   !    of well-mixed layer
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(  out) ::   pshear    ! Production of TKE due to shear across the pycnocline
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phbl      ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phml      ! ML depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pdh       ! Pycnocline depth
      !!
      INTEGER :: jj, ji   ! Loop indices
      !!
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zekman
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zri_p, zri_b   ! Richardson numbers
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         pshear(ji,jj) = 0.0_wp
      END DO   ;   END DO
      zekman(:,:) = EXP( -1.0_wp * pp_ek * ABS( ff_t(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ) * phbl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) /   &
         &               MAX( sustar(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), 1.e-8 ) )
      !
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
   ...
   SUBROUTINE zdf_osm_external_gradients( Kmm, kbase, pdtdz, pdsdz, pdbdz )
      ...
      !!----------------------------------------------------------------------   
      INTEGER,                            INTENT(in   ) ::   Kmm            ! Ocean time-level index
      INTEGER,  DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   kbase          ! OSBL base layer index
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(  out) ::   pdtdz, pdsdz   ! External gradients of temperature, salinity
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(  out) ::   pdbdz          !    and buoyancy
      !!
   ...
   SUBROUTINE zdf_osm_calculate_dhdt( pdhdt, phbl, pdh, pwb_ent, pwb_min,   &
      ...
      !!
      !!----------------------------------------------------------------------
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(  out) ::   pdhdt          ! Rate of change of hbl
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phbl           ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pdh            ! Pycnocline depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_ent        ! Buoyancy entrainment flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_min
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pdbdz_bl_ext   ! External buoyancy gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(  out) ::   pwb_fk_b       ! MLE buoyancy flux averaged over OSBL
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_fk         ! Max MLE buoyancy flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pvel_mle       ! Vvelocity scale for dhdt with stable ML and FK
      !!
      INTEGER  ::   jj, ji
   ...
   SUBROUTINE zdf_osm_timestep_hbl( Kmm, pdhdt, phbl, phbl_t, pwb_ent,   &
      ...
      !!----------------------------------------------------------------------
      INTEGER,                            INTENT(in   ) ::   Kmm        ! Ocean time-level index
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   pdhdt      ! Rates of change of hbl
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   phbl       ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phbl_t     ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_ent    ! Buoyancy entrainment flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_fk_b   ! MLE buoyancy flux averaged over OSBL
      !!
      INTEGER  ::   jk, jj, ji, jm
   ...
   SUBROUTINE zdf_osm_pycnocline_thickness( Kmm, pdh, phml, pdhdt, phbl,   &
      ...
      !!----------------------------------------------------------------------
      INTEGER,                            INTENT(in   ) ::   Kmm            ! Ocean time-level index
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   pdh            ! Pycnocline thickness
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   phml           ! ML depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pdhdt          ! BL depth tendency
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phbl           ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_ent        ! Buoyancy entrainment flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pdbdz_bl_ext   ! External buoyancy gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_fk_b       ! MLE buoyancy flux averaged over OSBL
   ...
   SUBROUTINE zdf_osm_pycnocline_buoyancy_profiles( Kmm, kp_ext, pdbdz, palpha, pdh,   &
      ...
      !!----------------------------------------------------------------------
      INTEGER,                                 INTENT(in   ) ::   Kmm            ! Ocean time-level index
      INTEGER,  DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   kp_ext         ! External-level offsets
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk),  INTENT(  out) ::   pdbdz          ! Gradients in the pycnocline
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(  out) ::   palpha
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdh            ! Pycnocline thickness
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   phbl           ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdbdz_bl_ext   ! External buoyancy gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   phml           ! ML depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdhdt          ! Rates of change of hbl
      !!
      INTEGER  ::   jk, jj, ji
      REAL(wp) ::   zbgrad
      ...
      IF ( ln_dia_pyc_scl ) THEN   ! Output of pycnocline gradient profiles
         CALL zdf_osm_iomput( "zdbdz_pyc", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * pdbdz(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
      END IF
      !
   ...
   SUBROUTINE zdf_osm_diffusivity_viscosity( Kbb, Kmm, pdiffut, pviscos, phbl,   &
      ...
      !!----------------------------------------------------------------------
      INTEGER,                                 INTENT(in   ) ::   Kbb, Kmm       ! Ocean time-level indices
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk),  INTENT(inout) ::   pdiffut        ! t-diffusivity
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk),  INTENT(inout) ::   pviscos        ! Viscosity
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   phbl           ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   phml           ! ML depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdh            ! Pycnocline depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdhdt          ! BL depth tendency
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pshear         ! Shear production
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pwb_ent        ! Buoyancy entrainment flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pwb_min
      !!
      INTEGER ::   ji, jj, jk   ! Loop indices
      !! Scales used to calculate eddy diffusivity and viscosity profiles
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdifml_sc,    zvisml_sc
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zdifpyc_n_sc, zdifpyc_s_sc
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zvispyc_n_sc, zvispyc_s_sc
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zbeta_d_sc,   zbeta_v_sc
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zb_coup,      zc_coup_vis,  zc_coup_dif
      !!
   ...
   !                  ENDIF
         ...
         !
      END DO   ;   END DO
      CALL zdf_osm_iomput( "pb_coup", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zb_coup(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )   ! BBL-coupling velocity scale
      !
   ...
   SUBROUTINE zdf_osm_fgr_terms( Kmm, kp_ext, phbl, phml, pdh,                              &
      ...
      INTEGER,  DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   kp_ext         ! Offset for external level
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   phbl           ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   phml           ! ML depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdh            ! Pycnocline depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdhdt          ! BL depth tendency
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pshear         ! Shear production
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdtdz_bl_ext   ! External temperature gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdsdz_bl_ext   ! External salinity gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)),      INTENT(in   ) ::   pdbdz_bl_ext   ! External buoyancy gradients
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk),  INTENT(in   ) ::   pdiffut        ! t-diffusivity
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk),  INTENT(in   ) ::   pviscos        ! Viscosity
      !!
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))     ::   zalpha_pyc   !
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1),jpk) ::   zdbdz_pyc    ! Parametrised gradient of buoyancy in the pycnocline
      ...
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zsc_wth_1,zsc_ws_1                      ! Temporary scales
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zsc_uw_1, zsc_uw_2                      ! Temporary scales
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zsc_vw_1, zsc_vw_2                      ! Temporary scales
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   ztau_sc_u                               ! Dissipation timescale at base of WML
      REAL(wp)                           ::   zbuoy_pyc_sc, zdelta_pyc                !
      REAL(wp)                           ::   zl_c,zl_l,zl_eps                        ! Used to calculate turbulence length scale
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   za_cubic, zb_cubic                      ! Coefficients in cubic polynomial specifying
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zc_cubic, zd_cubic                      !    diffusivity in pycnocline
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zwt_pyc_sc_1, zws_pyc_sc_1              !
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zzeta_pyc                               !
      REAL(wp)                           ::   zomega, zvw_max                         !
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zuw_bse,zvw_bse                         ! Momentum, heat, and salinity fluxes
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zwth_ent,zws_ent                        !    at the top of the pycnocline
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   zsc_wth_pyc, zsc_ws_pyc                 ! Scales for pycnocline transport term
      REAL(wp)                           ::   ztmp                                    !
      ...
      ! ------------------------------------------------------
      WHERE ( l_conv(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) )
         zsc_wth_1(:,:) = swstrl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 * swth0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) /   &
            &             ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + 0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + epsln )
         zsc_ws_1(:,:)  = swstrl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 * sws0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))  /   &
            &             ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + 0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + epsln )
      ELSEWHERE
         zsc_wth_1(:,:) = 2.0_wp * swthav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
         zsc_ws_1(:,:)  = 2.0_wp * swsav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
      ENDWHERE
      DO jk =  2,  MAX( jkm_mld, jkm_bld )  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( l_conv(ji,jj) ) THEN
      ...
      !
      IF ( ln_dia_osm ) THEN
         CALL zdf_osm_iomput( "ghamu_00", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamu(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
         CALL zdf_osm_iomput( "ghamv_00", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamv(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
      END IF
      !
      ...
      ! ---------------------------------------------------------------------
      WHERE ( l_conv(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) )
         zsc_uw_1(:,:) = ( swstrl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 +                                                &
            &              0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 )**pthird * sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) /   &
            &              MAX( ( 1.0_wp - 1.0_wp * 6.5_wp * sla(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**( 8.0_wp / 3.0_wp ) ), 0.2_wp )
         zsc_uw_2(:,:) = ( swstrl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 +                                                &
            &              0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 )**pthird * sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) /   &
            &              MIN( sla(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**( 8.0_wp / 3.0_wp ) + epsln, 0.12_wp )
         zsc_vw_1(:,:) = ff_t(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * phml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 *   &
            &            MIN( sla(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**( 8.0_wp / 3.0_wp ), 0.12_wp ) /                    &
            &            ( ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + 0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 )**( 2.0_wp / 3.0_wp ) + epsln )
      ELSEWHERE
         zsc_uw_1(:,:) = sustar(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**2
         zsc_vw_1(:,:) = ff_t(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * phbl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 *   &
            &            MIN( sla(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**( 8.0_wp / 3.0_wp ), 0.12_wp ) / ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**2 + epsln )
      ENDWHERE
      DO jk =  2,  MAX( jkm_mld, jkm_bld )  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( l_conv(ji,jj) ) THEN
            IF ( jk <= nmld(ji,jj) ) THEN
      ...
      ! ----------------------------------------------------------------------
      WHERE ( l_conv(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) )
         zsc_wth_1(:,:) = swbav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * swth0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * ( 1.0_wp + EXP( 0.2_wp * shol(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ) ) *   &
            &             phml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) / ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + 0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + epsln )
         zsc_ws_1(:,:)  = swbav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * sws0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))  * ( 1.0_wp + EXP( 0.2_wp * shol(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ) ) *   &
            &             phml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) / ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + 0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + epsln )
      ELSEWHERE
         zsc_wth_1(:,:) = 0.0_wp
         zsc_ws_1(:,:)  = 0.0_wp
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         ...
         END IF
      END DO   ;   END DO
      DO jk =  2,  jkm_bld  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
      ...
      !
      IF ( ln_dia_osm ) THEN
         CALL zdf_osm_iomput( "zwth_ent", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zwth_ent(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )   ! Upward turb. temperature entrainment flux
         CALL zdf_osm_iomput( "zws_ent",  tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zws_ent(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0))  )   ! Upward turb. salinity entrainment flux
      END IF
      !
      zsc_vw_1(:,:) = 0.0_wp
      WHERE ( l_conv(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) )
         zsc_uw_1(:,:) = -1.0_wp * swb0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * sustar(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**2 * phml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) /   &
            &            ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + 0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + epsln )
         zsc_uw_2(:,:) =           swb0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))    * phml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) /   &
            &            ( svstr(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + 0.5_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**3 + epsln )**( 2.0_wp / 3.0_wp )
      ELSEWHERE
         zsc_uw_1(:,:) = 0.0_wp
      ENDWHERE
      DO jk =  2,  MAX( jkm_mld, jkm_bld )  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         ...
         END IF
      END DO   ;   END DO
      DO jk =  jkf_mld,  jkm_bld  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)   ! Need ztau_sc_u to be available. Change to array.
      ...
      !
      IF ( ln_dia_osm ) THEN
         CALL zdf_osm_iomput( "ghamu_0",    wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamu(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:)  )
         CALL zdf_osm_iomput( "zsc_uw_1_0", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zsc_uw_1(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )
      END IF
      !
      ...
      ! -----------------------------------------------------------------------
      WHERE ( l_conv(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) )
         zsc_wth_1(:,:) = swth0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) / ( 1.0_wp - 0.56_wp * EXP( shol(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ) )
         zsc_ws_1(:,:)  = sws0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))  / ( 1.0_wp - 0.56_wp * EXP( shol(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ) )
         WHERE ( l_pyc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) )   ! Pycnocline scales
            zsc_wth_pyc(:,:) = -0.003_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * ( 1.0_wp - pdh(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) / phbl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ) *   &
               &               av_dt_ml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
            zsc_ws_pyc(:,:)  = -0.003_wp * swstrc(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * ( 1.0_wp - pdh(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) / phbl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ) *   &
               &               av_ds_ml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
         END WHERE
      ELSEWHERE
         zsc_wth_1(:,:) = 2.0_wp * swthav(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
         zsc_ws_1(:,:)  =          sws0(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
      END WHERE
      DO jk =  1,  MAX( jkm_mld, jkm_bld )  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
         IF ( l_conv(ji,jj) ) THEN
      ...
      WHERE ( l_conv(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) )
         zsc_uw_1(:,:) = sustar(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**2
         zsc_vw_1(:,:) = ff_t(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * phml(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
      ELSEWHERE
         zsc_uw_1(:,:) = sustar(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))**2
         zsc_uw_2(:,:) = ( 2.25_wp - 3.0_wp * ( 1.0_wp - EXP( -1.25_wp * 2.0_wp ) ) ) * ( 1.0_wp - EXP( -4.0_wp * 2.0_wp ) ) *   &
            &            zsc_uw_1(:,:)
         zsc_vw_1(:,:) = ff_t(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * sustke(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) * phbl(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1))
      ...
      !
      IF ( ln_dia_osm ) THEN
         CALL zdf_osm_iomput( "ghamu_f",    wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamu(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:)  )
         CALL zdf_osm_iomput( "ghamv_f",    wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamv(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:)  )
         CALL zdf_osm_iomput( "zsc_uw_1_f", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zsc_uw_1(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )
         CALL zdf_osm_iomput( "zsc_vw_1_f", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zsc_vw_1(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )
         CALL zdf_osm_iomput( "zsc_uw_2_f", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zsc_uw_2(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )
         CALL zdf_osm_iomput( "zsc_vw_2_f", tmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),1) * zsc_vw_2(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) )
      END IF
      !
      ...
      IF ( ln_dia_pyc_scl .OR. ln_dia_pyc_shr ) THEN   ! Allocate arrays for output of pycnocline gradient/shear profiles
         ALLOCATE( z3ddz_pyc_1(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk), z3ddz_pyc_2(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk), STAT=istat )
      ...
      END DO   ;   END DO   ;   END DO
      IF ( ln_dia_pyc_scl ) THEN   ! Output of pycnocline gradient profiles
         CALL zdf_osm_iomput( "zdtdz_pyc", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * z3ddz_pyc_1(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
         CALL zdf_osm_iomput( "zdsdz_pyc", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * z3ddz_pyc_2(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
      END IF
      DO jk =  2,  jkm_bld  ; DO jj = ntsj-(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*nthb), ntej+(   nn_hls-1-(  nn_hls-1+  nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+  nn_hls-1)*nthl), ntei+(   nn_hls-1-(  nn_hls-1+ nn_hls-1)*nthr)
      ...
      IF ( ln_dia_pyc_shr ) THEN   ! Output of pycnocline shear profiles
         CALL zdf_osm_iomput( "zdudz_pyc", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * z3ddz_pyc_1(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
         CALL zdf_osm_iomput( "zdvdz_pyc", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * z3ddz_pyc_2(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
      END IF
      IF ( ln_dia_osm ) THEN
         CALL zdf_osm_iomput( "ghamu_b", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamu(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
         CALL zdf_osm_iomput( "ghamv_b", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamv(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
      END IF
      ...
      !
      IF ( ln_dia_osm ) THEN
         CALL zdf_osm_iomput( "ghamu_1", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamu(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:)   )
         CALL zdf_osm_iomput( "ghamv_1", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * ghamv(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:)   )
         CALL zdf_osm_iomput( "zviscos", wmask(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) * pviscos(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) )
      END IF
      !
   ...
   SUBROUTINE zdf_osm_zmld_horizontal_gradients( Kmm, pmld, pdtdx, pdtdy, pdsdx,   &
      ...
      !!----------------------------------------------------------------------
      INTEGER,                            INTENT(in   ) ::   Kmm          ! Time-level index
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)),   INTENT(  out) ::   pmld         ! == Estimated FK BLD used for MLE horizontal gradients == !
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)),   INTENT(inout) ::   pdtdx        ! Horizontal gradient for Fox-Kemper parametrization
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)),   INTENT(inout) ::   pdtdy        ! Horizontal gradient for Fox-Kemper parametrization
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)),   INTENT(inout) ::   pdsdx        ! Horizontal gradient for Fox-Kemper parametrization
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)),   INTENT(inout) ::   pdsdy        ! Horizontal gradient for Fox-Kemper parametrization
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   pdbds_mle    ! Magnitude of horizontal buoyancy gradient
      !!
      INTEGER                               ::   ji, jj, jk   ! Dummy loop indices
      INTEGER,  DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls))      ::   jk_mld_prof  ! Base level of MLE layer
      INTEGER                               ::   ikt, ikmax   ! Local integers      
      REAL(wp)                              ::   zc
      REAL(wp)                              ::   zN2_c        ! Local buoyancy difference from 10m value
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls))      ::   ztm
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls))      ::   zsm
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpts) ::   ztsm_midu
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpts) ::   ztsm_midv
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpts) ::   zabu
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpts) ::   zabv
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls))      ::   zmld_midu
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls))      ::   zmld_midv
      !!----------------------------------------------------------------------
      !
      ! ==  MLD used for MLE  ==!
      ...
      DO jk =  nlb10,  jpkm1  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls)
         ikt = mbkt(ji,jj)
      ...
      END DO   ;   END DO
      !
      ikmax = MIN( MAXVAL( jk_mld_prof(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)) ), jpkm1 )   ! Max level of the computation
      ztm(:,:) = 0.0_wp
      zsm(:,:) = 0.0_wp
      DO jk =  1,  ikmax  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls)
      ...
      zmld_midu(:,:)   =  0.0_wp
      ztsm_midu(:,:,:) = 10.0_wp
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)
      ...
      zmld_midv(:,:)   =  0.0_wp
      ztsm_midv(:,:,:) = 10.0_wp
      DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)
      ...
      DO jj = ntsj-(  nn_hls-1-( nn_hls-1+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls-1)*ntht) ; DO ji = ntsi-( nn_hls-( nn_hls+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls)*nthr)
         dbdx_mle(ji,jj) = grav * ( pdtdx(ji,jj) * zabu(ji,jj,jp_tem) - pdsdx(ji,jj) * zabu(ji,jj,jp_sal) )
      END DO   ;   END DO
      DO jj = ntsj-(  nn_hls-( nn_hls+ nn_hls-1 )*nthb), ntej+(  nn_hls-1 -( nn_hls-1 + nn_hls)*ntht) ; DO ji = ntsi-( nn_hls-1-( nn_hls-1+ nn_hls-1)*nthl), ntei+(  nn_hls-1-( nn_hls-1+ nn_hls-1)*nthr)
         dbdy_mle(ji,jj) = grav * ( pdtdy(ji,jj) * zabv(ji,jj,jp_tem) - pdsdy(ji,jj) * zabv(ji,jj,jp_sal) )
      END DO   ;   END DO
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)
   ...
   SUBROUTINE zdf_osm_osbl_state_fk( Kmm, pwb_fk, phbl, phmle, pwb_ent,   &
      ...
      !!----------------------------------------------------------------------      
      INTEGER,                            INTENT(in   ) ::   Kmm         ! Time-level index
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   pwb_fk
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phbl        ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phmle       ! MLE depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb_ent     ! Buoyancy entrainment flux
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pdbds_mle   ! Magnitude of horizontal buoyancy gradient
      !!
      INTEGER                            ::   ji, jj, jk        ! Dummy loop indices
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)) ::   znd_param
      REAL(wp)                           ::   zthermal, zbeta
      REAL(wp)                           ::   zbuoy
      REAL(wp)                           ::   ztmp
   ...
   SUBROUTINE zdf_osm_mle_parameters( Kmm, pmld, phmle, pvel_mle, pdiff_mle,   &
      ...
      !!----------------------------------------------------------------------
      INTEGER,                            INTENT(in   ) ::   Kmm         ! Time-level index
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)),   INTENT(in   ) ::   pmld        ! == Estimated FK BLD used for MLE horiz gradients == !
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   phmle       ! MLE depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   pvel_mle    ! Velocity scale for dhdt with stable ML and FK
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(inout) ::   pdiff_mle   ! Extra MLE vertical diff
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pdbds_mle   ! Magnitude of horizontal buoyancy gradient
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   phbl        ! BL depth
      REAL(wp), DIMENSION(ntsi-(nn_hls-1):ntei+(nn_hls-1),ntsj-(nn_hls-1):ntej+(nn_hls-1)), INTENT(in   ) ::   pwb0tot     ! Total surface buoyancy flux including insolation
      !!
      INTEGER  ::   ji, jj, jk   ! Dummy loop indices
      REAL(wp) ::   ztmp
      REAL(wp) ::   zdbdz
...
904      IF( ios >  0 ) CALL ctl_nam( ios, 'namosm_mle in configuration namelist' )
      ...
      CASE ( 0 )                ! no horizontal average
         ...
         etmean(:,:,:) = 0.0_wp
         !
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls-1), ntei+(  nn_hls-1)
   ...
   SUBROUTINE dyn_osm( kt, Kmm, puu, pvv, Krhs )
      ...
      !
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)   ! Add non-local u and v fluxes
   ...
   SUBROUTINE zdf_osm_iomput_2d( cdname, posmdia2d )
      ...
      IF ( ln_dia_osm .AND. iom_use( cdname ) ) THEN
         IF ( SIZE( posmdia2d, 1 ) == ntei-ntsi+1 .AND. SIZE( posmdia2d, 2 ) == ntej-ntsj+1 ) THEN   ! Halo absent
            osmdia2d(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0)) = posmdia2d(:,:)
            CALL iom_put( cdname, osmdia2d(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls)) )
         ELSE   ! Halo present
   ...
   SUBROUTINE zdf_osm_iomput_3d( cdname, posmdia3d )
      ...
      IF ( ln_dia_osm .AND. iom_use( cdname ) ) THEN
         IF ( SIZE( posmdia3d, 1 ) == ntei-ntsi+1 .AND. SIZE( posmdia3d, 2 ) == ntej-ntsj+1 ) THEN   ! Halo absent
            osmdia3d(ntsi-(0):ntei+(0),ntsj-(0):ntej+(0),:) = posmdia3d(:,:,:)
            CALL iom_put( cdname, osmdia3d(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),:) )
         ELSE   ! Halo present
