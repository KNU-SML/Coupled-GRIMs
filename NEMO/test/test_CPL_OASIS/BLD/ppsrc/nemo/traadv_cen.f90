...
CONTAINS
   ...
   SUBROUTINE tra_adv_cen( kt, kit000, cdtype, pU, pV, pW,     &
      ...
      REAL(wp), DIMENSION(ntsi-(nn_hls):ntei+(nn_hls),ntsj-(nn_hls):ntej+(nn_hls),jpk) ::   zwx, zwy, zwz, ztu, ztv, ztw
      !!----------------------------------------------------------------------
      !
      ...
      DO jn = 1, kjpt            !==  loop over the tracers  ==!
         ...
         CASE(  4  )                         !* 4th order centered
            ...
            ztv(:,:,jpk) = 0._wp
            DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls-1) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls-1)          ! masked gradient
            ...
            !
            DO jk =  1,  jpkm1  ; DO jj = ntsj-(  nn_hls-1), ntej+(  0) ; DO ji = ntsi-( nn_hls-1), ntei+(  0)           ! Horizontal advective fluxes
         ...
         !
         CASE(  2  )                         !* 2nd order centered
            DO jk =  2,  jpk  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)
         ...
         ENDIF
         !
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 0), ntei+(  0)   !--  Divergence of advective fluxes  --!
