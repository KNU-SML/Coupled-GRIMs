...
CONTAINS
   ...
   SUBROUTINE ice_dyn_adv_umx( kn_umx, kt, pu_ice, pv_ice, ph_i, ph_s, ph_ip,  &
      ...
      DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls)
         ...
         ENDIF
      END DO   ;   END DO
      DO jj = ntsj-( nn_hls-1), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
   ...
   SUBROUTINE adv_umx( pamsk, kn_umx, jt, kt, pdt, pu, pv, puc, pvc, pubox, pvbox,  &
      ...
      IF( pamsk == 0._wp ) THEN
         DO jl = 1, jpl
            DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( 1), ntei+( 0)
               ...
               !
            END DO   ;   END DO
            DO jj = ntsj-( 1), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
      ...
      ELSE                              !** alternate directions **!
         ...
         IF( MOD( (kt - 1) / nn_fsbc , 2 ) ==  MOD( (jt - 1) , 2 ) ) THEN   !==  odd ice time step:  adv_x then adv_y  ==!
            ...
            DO jl = 1, jpl              !-- flux in x-direction
               DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)
                  pfu_ups(ji,jj,jl) = MAX( pu(ji,jj), 0._wp ) * pt(ji,jj,jl) + MIN( pu(ji,jj), 0._wp ) * pt(ji+1,jj,jl)
               END DO   ;   END DO
            END DO
            !
            DO jl = 1, jpl              !-- first guess of tracer from u-flux
               DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)
         ...
         ELSE                                                               !==  even ice time step:  adv_y then adv_x  ==!
            !
            DO jl = 1, jpl              !-- flux in y-direction
               DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
                  pfv_ups(ji,jj,jl) = MAX( pv(ji,jj), 0._wp ) * pt(ji,jj,jl) + MIN( pv(ji,jj), 0._wp ) * pt(ji,jj+1,jl)
               END DO   ;   END DO
            END DO
            !
            DO jl = 1, jpl              !-- first guess of tracer from v-flux
               DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
   ...
   SUBROUTINE macho( pamsk, kn_umx, jt, kt, pdt, pt, pu, pv, pubox, pvbox, pt_ups, pfu_ups, pfv_ups, pfu_ho, pfv_ho )
      ...
      IF( MOD( (kt - 1) / nn_fsbc , 2 ) ==  MOD( (jt - 1) , 2 ) ) THEN   !==  odd ice time step:  adv_x then adv_y  ==!
         ...
         DO jl = 1, jpl
            DO jj = ntsj-( nn_hls), ntej+( nn_hls ) ; DO ji = ntsi-( 0), ntei+( 0)
      ...
      ELSE                                                               !==  even ice time step:  adv_y then adv_x  ==!
         ...
         !                                                        !--  advective form update in zpt  --!
         DO jl = 1, jpl
            DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls)
   ...
   SUBROUTINE ultimate_x( kloop, pamsk, kn_umx, pdt, pt, pu, pt_u, pfu_ho )
      ...
      DO jl = 1, jpl
         DO jj = ntsj-( kloop), ntej+( kloop ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)      ! First derivative (gradient)
            ztu1(ji,jj,jl) = ( pt(ji+1,jj,jl) - pt(ji,jj,jl) ) * r1_e1u(ji,jj) * umask(ji,jj,1)
         END DO   ;   END DO
         DO jj = ntsj-( kloop), ntej+( kloop ) ; DO ji = ntsi-( nn_hls-1), ntei+( nn_hls-1)    ! Second derivative (Laplacian)
...
!!$         END DO
      ...
      DO jl = 1, jpl
         DO jj = ntsj-( kloop), ntej+( kloop ) ; DO ji = ntsi-( 1), ntei+( 0)                  ! Third derivative
            ztu3(ji,jj,jl) = ( ztu2(ji+1,jj,jl) - ztu2(ji,jj,jl) ) * r1_e1u(ji,jj) * umask(ji,jj,1)
         END DO   ;   END DO
         DO jj = ntsj-( kloop), ntej+( kloop ) ; DO ji = ntsi-( 0), ntei+( 0)                  ! Fourth derivative
...
!!$         END DO
      ...
      CASE( 1 )                                                   !==  1st order central TIM  ==! (Eq. 21)
         !
         DO jl = 1, jpl
            DO jj = ntsj-( kloop), ntej+( kloop ) ; DO ji = ntsi-( 1), ntei+( 0)
...
!!rachid          zdx2 = e1u(ji,jj) * e1t(ji,jj)
   ...
   SUBROUTINE ultimate_y( kloop, pamsk, kn_umx, pdt, pt, pv, pt_v, pfv_ho )
      ...
      DO jl = 1, jpl
         DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( kloop), ntei+( kloop)      ! First derivative (gradient)
            ztv1(ji,jj,jl) = ( pt(ji,jj+1,jl) - pt(ji,jj,jl) ) * r1_e2v(ji,jj) * vmask(ji,jj,1)
         END DO   ;   END DO
         DO jj = ntsj-( nn_hls-1), ntej+( nn_hls-1 ) ; DO ji = ntsi-( kloop), ntei+( kloop)    ! Second derivative (Laplacian)
      ...
      DO jl = 1, jpl
         DO jj = ntsj-( 1), ntej+( 0 ) ; DO ji = ntsi-( kloop), ntei+( kloop)                  ! Third derivative
            ztv3(ji,jj,jl) = ( ztv2(ji,jj+1,jl) - ztv2(ji,jj,jl) ) * r1_e2v(ji,jj) * vmask(ji,jj,1)
         END DO   ;   END DO
         DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( kloop), ntei+( kloop)                  ! Fourth derivative
      ...
      CASE( 1 )                                                !==  1st order central TIM  ==! (Eq. 21)
         DO jl = 1, jpl
            DO jj = ntsj-( 1), ntej+( 0 ) ; DO ji = ntsi-( kloop), ntei+( kloop)
...
!!rachid          zdy2 = e2v(ji,jj) * e2t(ji,jj)
   ...
   SUBROUTINE limiter_x( pdt, pu, pt, pfu_ups, pfu_ho )
      ...
      !
      DO jl = 1, jpl
         DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( nn_hls), ntei+( nn_hls-1)
      ...
      DO jl = 1, jpl
         DO jj = ntsj-( 0), ntej+( 0 ) ; DO ji = ntsi-( nn_hls-1), ntei+( 0)
   ...
   SUBROUTINE limiter_y( pdt, pv, pt, pfv_ups, pfv_ho )
      ...
      !
      DO jl = 1, jpl
         DO jj = ntsj-( nn_hls), ntej+( nn_hls-1 ) ; DO ji = ntsi-( 0), ntei+( 0)
      ...
      DO jl = 1, jpl
         DO jj = ntsj-( nn_hls-1), ntej+( 0 ) ; DO ji = ntsi-( 0), ntei+( 0)
   ...
   SUBROUTINE Hbig( pdt, phi_max, phs_max, phip_max, psi_max, pes_max, pei_max, &
      ...
      !                                           ! -- check e_i/v_i -- !
      DO jl = 1, jpl
         DO jk =  1,  nlay_i  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls)
            IF ( pv_i(ji,jj,jl) > 0._wp ) THEN
      ...
      !                                           ! -- check e_s/v_s -- !
      DO jl = 1, jpl
         DO jk =  1,  nlay_s  ; DO jj = ntsj-(  nn_hls), ntej+(  nn_hls) ; DO ji = ntsi-( nn_hls), ntei+(  nn_hls)
