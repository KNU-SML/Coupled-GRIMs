...
!!gm why not using a SHIFT instruction...
         DO jk =  1,  jpkm1  ; DO jj = ntsj-(  0), ntej+(  0) ; DO ji = ntsi-( 1), ntei+(  0)     !--- Computation of the ustream and downstream value of the tracer and the mask
   ...
   SUBROUTINE quickest( pfu, pfd, pfc, puc )
      ...
      !----------------------------------------------------------------------
      !
      DO jk =  1,  jpkm1  ; DO jj = ntsj-(  2), ntej+(  2) ; DO ji = ntsi-( 2), ntei+(  2)
